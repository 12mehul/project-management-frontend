                  ...
                  >
                    {(provided) => (
                      <div
                        ...
                        ref={provided.innerRef}
                        className="relative min-w-[260px] min-h-[180px] flex flex-col justify-between border-t-2 border-green-600 rounded-md transition duration-500 shadow-md hover:shadow-teal-400"
                      >
